...
import portlet.service.service.FacturaLocalService;
import portlet.service.service.FacturaLocalServiceUtil;
import portlet.service.service.persistence.FacturaPersistence;

/**
 * Provides the base implementation for the factura local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link portlet.service.service.impl.FacturaLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see portlet.service.service.impl.FacturaLocalServiceImpl
 * @generated
 */
public abstract class FacturaLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FacturaLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacturaLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacturaLocalServiceUtil</code>.
	 */
	...
	public Factura deleteFactura(long facturaId) throws PortalException {
		return facturaPersistence.remove(facturaId);
	}
	...
	public Factura deleteFactura(Factura factura) {
		return facturaPersistence.remove(factura);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return facturaPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Factura.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return facturaPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return facturaPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Factura fetchFactura(long facturaId) {
		return facturaPersistence.fetchByPrimaryKey(facturaId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(facturaLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Factura.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("facturaId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Factura.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("facturaId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return facturaPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return facturaLocalService.deleteFactura((Factura)persistedModel);
	}

	@Override
	public BasePersistence<Factura> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return facturaPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacturaLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		facturaLocalService = (FacturaLocalService)aopProxy;

		_setLocalServiceUtilService(facturaLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacturaLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		FacturaLocalService facturaLocalService) {

		try {
			Field field = FacturaLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, facturaLocalService);
		}
