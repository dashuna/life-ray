...
/**
 * Provides the local service interface for Factura. Methods of this
...
public interface FacturaLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>portlet.service.service.impl.FacturaLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the factura local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FacturaLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Factura deleteFactura(long facturaId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Factura fetchFactura(long facturaId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Factura getFactura(long facturaId) throws PortalException;
